    ...
    return (
      <div className="row">
        <div className="col-20" style={{ textAlign: "center" }}>
          <CommonDropDown id="regionDropDown" label={this.props.Content.regionDropdownLabel} onChange={this.handleDropdownChange.bind(this)} dropdownList={this.props.Content.regionDropDown} />
          <br />
